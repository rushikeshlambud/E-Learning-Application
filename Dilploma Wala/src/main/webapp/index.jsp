                ...
                <div class="row">
                    <div class="content col-lg-6 mx-auto">
                        ...
                        <div class="text-center">
                            ...
                            <irame style="height:100%; height: 250px;"  src="https://www.youtube.com/embed/hbWqYNzxLyw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                </div>
                <div class="content col-lg-6 mx-auto">
         ...
         <section id="page-content">
                ...
                <!-- <div class="row">
                    <div class="content col-lg-12 mx-auto">
                        ...
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-dark btn-lg"><a href="register.jsp">Register Now</a></button>
            ...
            <div class="row">
                <div class="content col-lg-5 mx-auto">
                    <img src="Images/img/24330.jpg" class="img-fluid">
                    </div>
                   <div class="content col-lg-7 mx-auto">
                       ...
                       <div class="text-center">
                           <br>
                           <h4 class="text-medium">New Batches Registration</h4>
                           <p class="lead m-b-40"> For new Java/Python batch register here</p>
 
                           <button type="button" class="btn btn-dark btn-lg" ><a href="./register.jsp" style="color:white;">Register Now</a></button>
                       </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="content col-lg-12 mx-auto">
                        ...
                        <div class="text-center">
                            <h2 class="text-medium">If you are already Registered ? </h2>
                            <p class="lead m-b-40">You can login here</p>

                            <button type="button" class="btn btn-dark btn-lg"><a href="./login.jsp" style="color:white;">login</a></button>
<!--                             <button type="button" class="btn btn-dark btn-lg"><a href="Registrationfees.jsp">Payment Completion(2021-2022)</a></button>
 -->
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="content col-lg-12 mx-auto">
                        ...
                        <div class="text-center">
                            <h2 class="text-medium">Demo Videos<!-- <img src="http://www.ariseacademynanded.com/tlptest.com/images/new.gif" height="40" width="40"> --></h2>
                            <p class="lead m-b-40">Watch our Classroom online free demo videos here</p>
                            <button type="button" class="btn btn-dark btn-lg"><a href="demo.jsp">Watch Online Mock Videos</a></button>
         ...
         <div class="heading-text heading-section text-center">
                    <h2>Why Diploma Wala Academy ?</h2>
                    ...
                    <div class="post-item border">
                        <div class="post-item-wrap">
                            <div class="post-video">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/C6WJiUNZf7U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 </div>
...
.</p>
                ...
                <div class="col-lg-3" style="background-color: #313131;">
                    <div class="text-box">
                        <a href="#"> <i class="fa fa-user-friends"></i>
                            <h3>Our Strength</h3>
                            <p>Arise Has The Best In Their Field Faculty.There Knowledge And Expertise To Deliver Successful And Practical Resolution To Your Studies</p>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3" style="background-color: #383838;">
        ...
        <section id="section3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <img alt="real-estate" src="Images/logo/agent.jpg" class="img-fluid m-b-10">
                    </div>
                    <div class="col-lg-7">
                        <h2 class="text-medium">Sam Altmon</h2>
                        <h4 class="text-small">CEO </h4>
                        <p>At the very outset, I would like to extend my sincere thanks and regards to the residents of Maharashtra for
making Diploma Wala as the most preferred coaching institute of engineering exams.
With the present scenario of globalization, the needs of engineering & technology require mandatorily
to be professional from the internationally recognized institution.
We, at Diploma Wala, commited to each of its students to achieve success by providing knowledge and skill
