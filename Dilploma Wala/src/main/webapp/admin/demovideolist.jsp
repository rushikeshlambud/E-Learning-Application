...
<div class="row " style="min-height:600px;">
	<div class="col-md-2">
       ...
       <table class="table table-bordered">
       			...
       			PreparedStatement ps=con.prepareStatement("select * from demovideos");
       			...
       			<tr class="bg-white t<%=i%>">
					...
					<br>
       				...
       				<a href="deldemovideos.jsp?id=<%=rs.getString(1)%>"><button class="btn btn-danger"><span class="fa fa-trash"></span></button></a></td>
       			</tr>
       			<%}con.close(); %>
       			</tbody>
       </table>
      ...
      <div class="video-pop-up">
		...
		<h3>Update Video Details</h3>
			...
			<form class="form-horizontal" id="form"  method="post">
        			...
        			<button class="btn btn-success" onclick="update_evideodemo()" type="button">Submit</button>
        			</div>
        		</form>
