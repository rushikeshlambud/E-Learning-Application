                ...
                <div class="container">
                    ...
                    <div id="logo">
                        <a href="index.jsp" class="logo" data-src-dark="images/logo-dark.png">
                            <img src="../Images/logo/logo.png" alt="Arise Academy"  style="height: 80px;">
                        </a>
                    </div>
                    <!--End: Logo-->
...
<!--                                        <li><a href="feesstructure.jsp">Fees Structure</a></li> -->
                                        <li class="dropdown"> <a href="../feesstructure.jsp">Fees Structure</a>
...
<!--                                                 <li><a href="#">ENTREANCE EXAM</a></li> -->
                                        ...
                                        <%}else{
                                        	...
                                        	%>
                                        <li class="dropdown"> <a href="index.jsp">Admin<i class="fa fa-user"></i></a>
                                        <%}else{ %>
