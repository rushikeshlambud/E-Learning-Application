...
<!--         			<option value="Repeater">Repeater</option> -->
        			...
        			<label>Uploading Date</label>
        				<input id="title" class="form-control bor" name="videoDate" placeholder="Video Date" type="date" value="" required="" autocomplete="off">
        			</div>
	...
	$('.getsub').change(function(){
		...
		if($(this).val()=="Repeater")
			{
			$('.sr').html('<label>Select Track</label><select class="combobox input-large form-control bor getsub1" name="rstd" required=""><option value="">Select Track</option><option value="11th">Track 1</option><option value="12th">Track 2</option></select>');
			$('.sr,.rupload-db').show();	
			$('.upload-db').hide();	
