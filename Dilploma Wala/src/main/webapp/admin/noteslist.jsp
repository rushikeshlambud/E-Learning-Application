       ...
       ResultSet rs=ps.executeQuery();
        ...
        <div class="col-md-9 body-pannel">
			...
			<div class="col-md-4 ad-batches">
        		...
        		%>
        		<a href="getnoteslist.jsp?xsb=<%=obj.getString("sub_Id")%>&cls=First Year&btc=<%=rs.getString(1)%>" style="color:white"><%=obj.getString("sub_Name")%></a>
        		<%}} %>
        		</div>
        	</div>
        	<%} %>
  ...
  <hr style="background: green; height: 2px;">
     ...
     %>
			...
			<div class="col-md-4 ad-batches">
        		...
        		if(!obj.getString("combine").equals("yes")){
        		%>
        		<a href="getnoteslist.jsp?xsb=<%=obj.getString("sub_Id")%>&cls=Second Year&btc=<%=rs.getString(1)%>" style="color:white"><%=obj.getString("sub_Name")%></a>
        		<%}} %>
        		</div>
        	</div>
        	<%} %>
     ...
     %>	<%while(rs.next()){ %>
			<div class="col-md-4 ad-batches">
        		...
        		if(!obj.getString("combine").equals("yes")){
        		%>
       <a href="getnoteslist.jsp?xsb=<%=obj.getString("sub_Id")%>&cls=Third Year&btc=<%=rs.getString(1)%>" style="color:white"><%=obj.getString("sub_Name")%></a>
